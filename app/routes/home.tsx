  ...
  return (
    <div className="min-h-screen bg-gray-50 flex items-center justify-center">
      <div className="max-w-md mx-auto text-center">
        <h1 className="text-4xl font-bold text-gray-900 mb-4">Welcome to My Remix App</h1>
        ...
        {user ? (
          <div className="space-y-4">
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <p className="text-gray-600 mb-4">You are successfully authenticated with WorkOS.</p>
        ...
        <div className="mt-8 bg-white p-6 rounded-lg shadow-md">
          <h3 className="text-lg font-semibold text-gray-800 mb-4">Convex Database Status</h3>
          <div className="text-left">
            {users === undefined ? (
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">Users in database: {users.length}</p>
              </div>
            )}
          </div>
        </div>
